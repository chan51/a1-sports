...
class ExpoImageManipulator extends Component {
  ...
  render() {
    ...
    const cropWidth =
      imageRatio < cropRatio ? width - 60 : originalHeight / imageRatio;
    const cropHeight =
      imageRatio < cropRatio ? width * imageRatio - 60 : originalHeight;
              ...
              {!cropMode ? (
                <View style={{ flexDirection: 'row' }}>
                  ...
                  >
                    ...
                    >
                      <Image
                        source={require('../../assets/manipulator/crop-free.png')}
                    ...
                    {allowRotate && (
                      ...
                      >
                        <Image
                          source={require('../../assets/manipulator/rotate-left.png')}
                          style={{ width: 24, height: 24 }}
                        ></Image>
                      </TouchableOpacity>
                    )}
                    {allowFlip && (
                      <>
                        ...
                        >
                          <Image
                            source={require('../../assets/manipulator/flip-vertical.png')}
                            style={{ width: 24, height: 24 }}
                          ></Image>
                        </TouchableOpacity>
                        <TouchableOpacity
                        ...
                        >
                          <Image
                            source={require('../../assets/manipulator/flip-horizontal.png')}
                            style={{ width: 24, height: 24 }}
                          ></Image>
                        </TouchableOpacity>
                      </>
              ...
              {!!cropMode && (
                <ImageCropOverlay
                  onLayoutChanged={(top, left, width, height) => {
                    ...
                    this.currentSize.height = height - 14;
