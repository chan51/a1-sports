...
export const TermsConditions: React.FC = () => {
  return (
    <View style={{ marginBottom: 90 }}>
      ...
      <Text>
        Welcome to echelon innovations (&ldquo;Company&rdquo;, &ldquo;we&rdquo;,
      ...
      <Text>
        echelon innovations has the right but not the obligation to monitor and
      ...
      <Text>
        ...
        of echelon innovations or used with permission. You may not distribute,
      ...
      <Text>
        ...
        echelon innovations and its licensors. Service is protected by
        ...
        without the prior written consent of echelon innovations.
      </Text>
      <View>
        <Text>{'\n'}</Text>
      </View>
      ...
      <Text>
        ...
        are not owned or controlled by echelon innovations.
      </Text>
      <View>
        <Text>{'\n'}</Text>
      </View>
      <Text>
        echelon innovations has no control over, and assumes no responsibility
      ...
      <Text>
        ...
        documents. PolicyMaker&rsquo;s Terms and Conditions generator is an
