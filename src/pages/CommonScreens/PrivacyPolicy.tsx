...
export const PrivacyPolicy: React.FC = () => {
  return (
    <View style={{ marginBottom: 150 }}>
      <View>
        <Text>Last updated: 2021-02-17</Text>
        <View>
          <Text>{'\n'}</Text>
        </View>
        ...
        <Text>
          Welcome to Kreatv Media house private limited (“Company”, “we”, “our”,
          “us”)!
        </Text>
        <View>
          <Text>{'\n'}</Text>
        ...
        <Text>
          ...
          <Text>contact@kreatvs.com </Text>so we can try to find a solution.
        ...
        <Text>
          <Text>
            ...
            emailing at contact@kreatvs.com.
          </Text>
        </Text>
        <View>
          <Text>{'\n'}</Text>
        </View>
        <Text>3. Contests, Sweepstakes and Promotions</Text>
        <View>
          <Text>{'\n'}</Text>
        </View>
        <Text>
      ...
      <View>
        ...
        <Text>
          Kreatv Media house private limited has the right but not the
        ...
        <Text>
          ...
          of Kreatv Media house private limited or used with permission. You may
          not distribute, modify, transmit, reuse, download, repost, copy, or
          use said Content, whether in whole or in part, for commercial purposes
          or for personal gain, without express advance written permission from
          us.
        </Text>
        <View>
          <Text>{'\n'}</Text>
        </View>
        <Text>5. Prohibited Uses</Text>
        <View>
          <Text>{'\n'}</Text>
        </View>
        <Text>
      ...
      <View>
        ...
        <Text>
          <Text>0.7.</Text>
          <Text>Attack Service via a </Text>
          <Text>denial-of-service</Text> attack or a distributed
          <Text>denial-of-service</Text> attack.
        </Text>
        <View>
          <Text>{'\n'}</Text>
        </View>
      ...
      <View>
        ...
        <Text>9. Intellectual Property</Text>
        <View>
          <Text>{'\n'}</Text>
        </View>
        <Text>
          ...
          property of Kreatv Media house private limited and its licensors.
          ...
          any product or service without the prior written consent of Kreatv
          Media house private limited.
        </Text>
        <View>
          <Text>{'\n'}</Text>
        </View>
        <Text>10. Copyright Policy</Text>
        <View>
          <Text>{'\n'}</Text>
        </View>
        <Text>
        ...
        <Text>
          ...
          to contact@kreatvs.com, with the subject line: “Copyright
      ...
      <View>
        ...
        <Text>
          ...
          <Text>contact@kreatvs.com</Text>.
        </Text>
        <Text>12. Error Reporting and Feedback</Text>
        <View>
          <Text>
            You may provide us either directly at
            <Text>contact@kreatvs.com </Text>or via third party sites and tools
            ...
            <Text>free-of-charge,</Text> <Text>sub-licensable,</Text> unlimited
          ...
          <Text>{'\n'}</Text>
          <Text>13. Links To Other Web Sites</Text>
          <View>
            <Text>{'\n'}</Text>
          </View>
        </View>
      ...
      <View>
        <Text>
          ...
          that are not owned or controlled by Kreatv Media house private
          limited.
        </Text>
        <View>
          <Text>{'\n'}</Text>
        ...
        <Text>
          Kreatv Media house private limited has no control over, and assumes no
        ...
        <Text>14. Disclaimer Of Warranty</Text>
        <View>
          <Text>{'\n'}</Text>
        </View>
        <Text>
      ...
      <View>
        ...
        <Text>15. Limitation Of Liability</Text>
        <View>
          <Text>{'\n'}</Text>
        </View>
        <Text>
      ...
      <View>
        ...
        <Text>18. Changes To Service</Text>
        <View>
          <Text>{'\n'}</Text>
        </View>
        <Text>
        ...
        <Text>19. Amendments To Terms</Text>
        <View>
          <Text>{'\n'}</Text>
        </View>
        <Text>
        ...
        <Text>20. Waiver And Severability</Text>
        <View>
          <Text>{'\n'}</Text>
        </View>
        <Text>
      ...
      <View>
        ...
        <Text>EXTERNAL LINKS DISCLAIMER</Text>
        <View>
          <Text>{'\n'}</Text>
        </View>
        <Text>
        ...
        <Text>
          For example, the outlined Disclaimer has been created using
          PolicyMaker.io, a free web application for generating high-quality
          legal documents. PolicyMaker’s disclaimer generator is an easy-to-use
          tool for creating an excellent sample Disclaimer template for a
          website, blog, eCommerce store or app.
        </Text>
        <View>
          <Text>{'\n'}</Text>
        </View>
      ...
      <View>
        ...
        <Text>ERRORS AND OMISSIONS DISCLAIMER</Text>
        <View>
          <Text>{'\n'}</Text>
        </View>
        <Text>
          While we have made every attempt to ensure that the information
          contained in this site has been obtained from reliable sources, Kreatv
          Media house private limited is not responsible for any errors or
        ...
        <Text>
          In no event will Kreatv Media house private limited, its related
        ...
        <Text>LOGOS AND TRADEMARKS DISCLAIMER</Text>
        <View>
          <Text>{'\n'}</Text>
        </View>
        <Text>
        ...
        <Text>Effective date: 2021-02-17</Text>
        <View>
          <Text>{'\n'}</Text>
        </View>
        <Text>
        ...
        <Text>Welcome to Kreatv Media house private limited</Text>
        <View>
          <Text>{'\n'}</Text>
        </View>
      </View>
      <View>
        ...
        <Text>
          ATA CONTROLLER means a natural or legal person who (either alone or
        ...
        <Text>
          ...
          <Text>Types of Data Collected Personal Data</Text>
          <View>
            <Text>{'\n'}</Text>
          </View>
        </Text>
      ...
      <View>
        ...
        <Text>
          ...
          <Text>Address, Country, State, Province, ZIP/Postal code, City</Text>
          <View>
            <Text>{'\n'}</Text>
          </View>
        </Text>
        ...
        <Text>
          ...
          website and stored on your device. Other
        </Text>
        <View>
          <Text>{'\n'}</Text>
        </View>
      ...
      <View>
        ...
        <Text>
          Kreatv Media house private limited uses the collected data for various
          purposes:
        </Text>
        <View>
          <Text>{'\n'}</Text>
        ...
        <Text>
          ...
          <Text>to fulfil any other purpose for which you provide it;</Text>
          <View>
            <Text>{'\n'}</Text>
          </View>
        </Text>
      ...
      <View>
        ...
        <Text>
          ...
          <Text>for any other purpose with your consent.</Text>
          <View>
            <Text>{'\n'}</Text>
          </View>
        </Text>
        ...
        <Text>
          Kreatv Media house private limited will take all the steps reasonably
        ...
        <Text>
          ...
          <Text>Disclosure for Law Enforcement.</Text>
          <View>
            <Text>{'\n'}</Text>
          </View>
        </Text>
      ...
      <View>
        ...
        <Text>
          ...
          <Text>Other cases. We may disclose your information also:</Text>
          <View>
            <Text>{'\n'}</Text>
          </View>
        </Text>
        <Text>
          ...
          <Text>to our subsidiaries and affiliates;</Text>
          <View>
            <Text>{'\n'}</Text>
          </View>
        </Text>
        ...
        <Text>
          ...
          <Text>to fulfill the purpose for which you provide it;</Text>
          <View>
            <Text>{'\n'}</Text>
          </View>
        </Text>
        ...
        <Text>
          ...
          <Text>with your consent in any other cases;</Text>
          <View>
            <Text>{'\n'}</Text>
          </View>
        </Text>
      ...
      <View>
        ...
        <Text>
          ...
          <Text>users can visit our site anonymously;</Text>
          <View>
            <Text>{'\n'}</Text>
          </View>
        </Text>
      ...
      <View>
        ...
        <Text>
          ...
          the information. If you choose to delete your personal information,
        ...
        <Text>
          ...
          please send your request(s) by email: contact@kreatvs.com.
        </Text>
        <View>
          <Text>{'\n'}</Text>
        </View>
      ...
      <View>
        ...
        <Text>
          ...
          <Text>Behavioral Remarketing</Text>
          <View>
            <Text>{'\n'}</Text>
          </View>
        </Text>
        ...
        <Text>
          ...
          tool for creating a privacy policy for blog, website, e-commerce store
          or mobile app.
        </Text>
        <View>
          <Text>{'\n'}</Text>
